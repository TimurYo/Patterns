...
public class Data {
    ...
    public static String generateCity() {
        var cities = new String[]{"Майкоп", "Горно-Алтайск", "Уфа", "Улан-Уда", "Махачкала",
                "Marac", "Нальчик", "Элиста", "Черкесск", "Петрозаводск", "Сыктывкар", "Симферополь", "Йошкар-Ола", "Саранск",
                ...
                "Владивосток", "Ставрополь", "Хабаровск", "Благовеценск", "Архангельск", "Астрахань", "Белгород",
                "Брянск", "Владимир", "Волгоград", "Вологда", "Воронеж",
                "Иваново", "Орёл", "Иркутск", "Калининград", "Калуга", "Кемерово", "Киров", "Кострома", "Курган", "Курск",
                ...
                "Смоленск", "Тамбов", "Тверь", "Томск", "Тула", "Томень", "Ульяновск", "Челябинск",
